...
class _Module3PageState extends State<Module3Page> {
  ...
  // Configuration matching Module 1 and 2 structure
  final List<Map<String, dynamic>> _lessonConfigs = [
    {
      'id': 'Lesson 3.1',
      'title': 'Lesson 3.1: Understanding Customer Issues',
      'description':
          'Master active listening skills to identify key information in customer calls.',
      'color': const Color(0xFF32CD32),
      'firestoreId': 'Lesson-3-1',
      'totalQuestions':
          60, // Based on maxPossibleAIScore from your existing lesson
    },
    {
      'id': 'Lesson 3.2',
      'title': 'Lesson 3.2: Speaking Practice & Pronunciation',
      'description':
          'Practice repeating dialogues to improve pronunciation and speaking clarity.',
      'color': const Color(0xFF32CD32),
      'firestoreId': 'Lesson-3-2',
      'totalQuestions': 50, // Placeholder - adjust based on actual lesson
    },
  ];
  ...
  Future<void> _loadModuleProgress() async {
    ...
    try {
      final results = await Future.wait([
        _progressService.getModuleAssessmentAttempts('module_3_final'),
        ..._lessonConfigs.map(
      ...
      _logger.e('Error loading Module 3 progress: $e');
  ...
  void _navigateToLesson(String lessonId) {
    ...
    switch (lessonId) {
      case 'Lesson 3.1':
        ...
        break;
      case 'Lesson 3.2':
        routeName = '/lesson3_2'; // You'll need to create this
        break;
    }
                ...
                child: _assessmentAttempts.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          // ✅ FIX: Safe type conversion to handle both int and double
                          ...
                          final int maxScore = (maxScoreValue is num)
                              ? maxScoreValue.toInt()
                              : 20; // Default for Module 3 assessments

                          // ✅ FIX: Use double division and then round to int
      ...
      body: _isLoading
          ? const Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  CircularProgressIndicator(color: Color(0xFF32CD32)),
                  SizedBox(height: 16),
  ...
  Widget _buildLessonCard(Map<String, dynamic> config, int index) {
    ...
    // ✅ FIX: Handle both int and double types for score
    final lastScore = isCompleted
        ? ((attempts.last['score'] as num?)?.toInt() ?? 0)
        : 0;
                      ...
                      children: [
                        ...
                        Text(
                          _allLessonsCompleted
                              ? 'Test your listening and speaking skills'
