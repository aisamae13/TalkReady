// lib/lessons/lesson2_1_activity_page.dart
import 'package:flutter/material.dart';
import 'package:logger/logger.dart';
import '../services/unified_progress_service.dart';
import '../widgets/ai_feedback_display_card.dart'; // Make sure this import is present

class Lesson2_1ActivityPage extends StatefulWidget {
  final String lessonId;
  final String lessonTitle;
  final Map<String, dynamic> lessonData;
  final int attemptNumber;

  const Lesson2_1ActivityPage({
    super.key,
  ...
  @override
  State<Lesson2_1ActivityPage> createState() => _Lesson2_1ActivityPageState();
}

class _Lesson2_1ActivityPageState extends State<Lesson2_1ActivityPage> {
  ...
  Future<void> _saveFinalAttempt() async {
    ...
    final detailedResponses = {
      'scenarioAnswers_L2_1': _answers,
      'scenarioFeedback_L2_1': _feedback,
    };
    ...
    try {
      await _progressService.saveLessonAttempt(
        ...
        timeSpent: 0, // Timer not implemented for this lesson
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      '• After submitting, you will receive feedback and have a chance to revise your answers.',
                    ),
                  ],
                ),
              ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // **UPDATED:** Using the reusable feedback card
  ...
  Widget _buildActionButton() {
    ...
    // After initial feedback, before revision
    return Row(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                // Pop twice to go back to the module page, skipping the lesson page
                int count = 0;
            ...
            TextButton(
              onPressed: () {
                // Pop just once to go back to the lesson page
